...
abstract contract OVRFLOFactoryHandler is Properties {
    ...
    function oVRFLOFactory_secondary(uint8 selector, uint256 arg0, uint256 arg1, address treasurySeed) public {
        ...
        if (selector == 0) {
            ...
            _oVRFLOFactory_setLendingTreasury(toActor(treasurySeed));
        } else {
