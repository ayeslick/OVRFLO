...
contract OVRFLOLendingTest is Test {
    ...
    function test_GatherLiquidity_SufficientCapacity() public {
        ...
        (uint256[] memory ids, bool sufficient) = lending.gatherLiquidity(MARKET, 500, 100 ether, 1, address(0));
    ...
    function test_GatherLiquidity_SkipsCancelledAndDepleted() public {
        ...
        (uint256[] memory ids, bool sufficient) = lending.gatherLiquidity(MARKET, 1000, 100 ether, 1, address(0));
        assertFalse(sufficient);
    ...
    function test_GatherLiquidity_StartIdBeyondRange() public {
        ...
        (uint256[] memory ids, bool sufficient) = lending.gatherLiquidity(MARKET, 1000, 100 ether, 99, address(0));
        assertFalse(sufficient);
        assertEq(ids.length, 0);
    }
    ...
    function test_GatherLiquidity_ExpiredSeriesReverts() public {
        ...
        vm.warp(expiry);
        vm.expectRevert();
        lending.gatherLiquidity(MARKET, 1000, 100 ether, 1, address(0));
    }
    ...
    function test_GatherLiquidity_ExcludesCallerOwnPositions() public {
        ...
        (uint256[] memory ids, bool sufficient) = lending.gatherLiquidity(MARKET, 1000, 100 ether, 1, BUYER);
