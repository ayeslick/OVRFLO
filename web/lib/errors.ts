...
export const errorCatalog = {
  ...
  ExceedsDeposited: { copy: "The requested amount exceeds what was deposited.", recovery: changeAmount },
  ...
  FlashCallbackFailed: { copy: "The flash-loan callback failed.", recovery: refresh },
  FlashPaused: { copy: "Flash loans are paused.", recovery: none },
