...
**What to build:** Every ESLint versus Oxlint difference is classified A–E in the checked-in ledger. ESLint may be removed only when the ledger has zero unclassified items and zero C items, and no-console plus scripts-override fixtures still pass. Anti-slop rules enable only with named repo evidence.
...
- the checked-in A–E ledger path selected in ticket 23
- this ticket's acceptance criteria

## Acceptance criteria

- [ ] Same-source runs produce a complete classified difference set with no unmatched finding
